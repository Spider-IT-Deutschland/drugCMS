...
/*
################################################################################
// FIXME  Following lines of code would ensure that previous selected optional 
...
if (strlen($_SESSION['dbmode'])) {
    $cfg['database_extension'] = strtolower($_SESSION['dbmode']);
} elseif (hasMySQLExtension() && !hasMySQLiExtension()) {
    // use MySQL extension by default if available
    $cfg['database_extension'] = 'mysql';
} elseif (hasMySQLiExtension()) {
    // use MySQLi extension if available
