...
$ui->addCancel($sess->url("main.php?area=mydrugcms_tasks&frame=$frame"));

$ui->setVar("area","mydrugcms_tasks");
...
$cpage->addScript("cal", '<style type="text/css">@import url(scripts/jscalendar/calendar-drugcms.css);</style>
