...
Ausgeschlossen davon sind 'drugcms/', 'setup/', 'cms/upload', 'cms/front_content.php', usw.
...
drugcms/plugins/mod_rewrite/*:
--------------------------------
Die Sourcen des Plugins.

drugcms/classes/UrlBuilder/Contenido_UrlBuilder_MR.class.php:
---------------------------------------------------------------
...
http://localhost/drugcms/plugins/mod_rewrite/install.php
...
anzuhängen, z. B. /drugcms/plugins/mod_rewrite/install.php?contenido={my_session_id}.
...
[code]
RewriteEngine on
RewriteRule ^ http://www.drugcms.org [R,L]
[/code]

Nach Eingabe der URL in die Adresszeile des Browsers, sollte auf www.drugcms.org weitergeleitet 
werden.
