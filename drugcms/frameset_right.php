...
if (isset($_GET['idartlang'])) {
    ...
    $changeview = 'edit';
    $tpl->set('s', 'FRAME[3]', str_replace("&", "&amp;", $sess->url("main.php?area=con&frame=3&changeview=".$changeview."&idcat=".$idcat."&idart=".$idart."&idartlang=".$idartlang."&action=".$action)));
    $tpl->set('s', 'FRAME[4]', str_replace("&", "&amp;", $sess->url("main.php?area=".$area."&changelang=".$_GET['changelang']."&changeview=".$changeview."&frame=4&action=".$action."&idcat=".$idcat."&idart=".$idart."&idartlang=".$idartlang)));
}
