...
class sftp {
    ...
    public function __construct($host, $port, $user, $password, $rootdir) {
        ...
        $this->conn = new Net_SFTP($host, $port);
        if ($this->conn->login($user, $password)) {
            $this->path = $this->conn->pwd();
            return true;
        }
        return false;
    }
...
*/
    ...
    public function rmdir($dir, $recursive = false) {
        ...
        return $this->conn->rmdir($dir);
    }
    
    public function isdir($dir) {
        return $this->conn->is_dir($dir);
    }
    ...
    public function get($file) {
        return $this->conn->get($file);
    }
    
    public function put($file, $sourcefile) {
        return $this->conn->put($sourcefile, $file, NET_SFTP_LOCAL_FILE);
    }
