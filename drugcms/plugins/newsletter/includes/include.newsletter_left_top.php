...
if ($perm->have_perm_area_action('news_jobs')) {
	...
	$sButtonRow .= '<img onmouseover="hoverEffect(\''.$sId.'\', \'in\')" onmouseout="hoverEffect(\''.$sId.'\', \'out\')" alt="'.i18n("Dispatch", $plugin_name).'" title="'.i18n("Dispatch", $plugin_name).'" name="'.$sId.'" id="'.$sId.'" src="'.$cfg["path"]["images"].'newsletter_dispatch_on.gif"/>';
	$sButtonRow .= '</a>';
}
...
if ($perm->have_perm_area_action('recipients')) {
	...
	$sButtonRow .= '<img onmouseover="hoverEffect(\''.$sId.'\', \'in\')" onmouseout="hoverEffect(\''.$sId.'\', \'out\')" alt="'.i18n("Recipients", $plugin_name).'" title="'.i18n("Recipients", $plugin_name).'" id="'.$sId.'" src="'.$cfg["path"]["images"].'newsletter_recipients_on.gif"/>';
	$sButtonRow .= '</a>';
}
...
if ($perm->have_perm_area_action('recipientgroups')) {
	...
	$sButtonRow .= '<img onmouseover="hoverEffect(\''.$sId.'\', \'in\')" onmouseout="hoverEffect(\''.$sId.'\', \'out\')" alt="'.i18n("Recipient groups", $plugin_name).'" title="'.i18n("Recipient groups", $plugin_name).'" id="'.$sId.'" src="'.$cfg["path"]["images"].'newsletter_recipientgroups_on.gif"/>';
	$sButtonRow .= '</a>';
}
...
if ($perm->have_perm_area_action("news", "news_create"))
{
	...
	$oLink->setContent('<img style="margin-right: 4px;" src="'.$cfg["path"]["images"] . 'folder_new.gif" align="middle">'.i18n("Create newsletter", $plugin_name));
...
$aFields["cronjob"]	= array("field" => "use_cronjob",	"caption" => i18n("Use cronjob", $plugin_name), "type" => "base");
...
$sContent .= '   <table>'."\n";
$sContent .= '      <tr>'."\n";
$sContent .= '         <td>'. i18n("Author", $plugin_name).'</td>'."\n";
...
$sContent .= '   <table>'."\n";
$sContent .= '      <tr>'."\n";
$sContent .= '         <td>'. i18n("Purge timeframe", $plugin_name).':</td>'."\n";
$sContent .= '         <td>'.$oTxtTimeframe->render().'&nbsp;'.i18n("days", $plugin_name).'</td>'."\n";
$sContent .= '      </tr>'."\n";
$sContent .= '      <tr>'."\n";
$sContent .= '         <td>&nbsp;</td>'."\n";
...
$sContent .= '      </tr>'."\n";
$sContent .= '      <tr>'."\n";
$sContent .= '         <td>'. i18n("Show group", $plugin_name).'</td>'."\n";
