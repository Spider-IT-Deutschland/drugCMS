...
if ( isset($idcat) )
{
    ...
    $scripts .= "\n<!-- tinyMCE -->\n".'<script type="text/javascript" src="'.$cfg["path"]["contenido_fullhtml"].'external/wysiwyg/tinymce3/jscripts/tiny_mce/tiny_mce.js"></script>';
            ...
            if ( $db->f("idtplcfg") != 0 ) {
                ...
                $code = '
                        <html>
                            <head>
                                <title>Error</title>
                                <link rel="stylesheet" type="text/css" href="'.$cfg["path"]["contenido_fullhtml"].$cfg["path"]["styles"].'drugcms.css"></link>
                            </head>
