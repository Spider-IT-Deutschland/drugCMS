...
$aManagedProperties = array(
                          ...
                          array('type' => 'update', 'name' => 'news_feed', 'value' => array('false', 'true'), 'label' => i18n('Get news from drugcms.org'), 'group' => i18n('Update notifier')),
...
$sRowTemplate = '<div style="margin:0; padding:3px;">%s</div>';
