...
$cfg['templates']['upl_files_upload']               = 'template.upl_files_upload.html';
...
$cfg['templates']['mydrugcms_settings']             = 'template.mydrugcms_settings.html';
$cfg['templates']['mydrugcms_overview']             = 'template.mydrugcms_overview.html';
$cfg['templates']['mydrugcms_start']                = 'template.mydrugcms_start.html';
$cfg['templates']['mydrugcms_lastarticles']         = 'template.mydrugcms_lastarticles.html';
$cfg['templates']['mydrugcms_subnav']               = 'template.mydrugcms_subnav.html';
