...
if(isset($_REQUEST["filter"])) $oPagerLink->setCustom("filter", stripslashes($_REQUEST["filter"]));
if(isset($_REQUEST["sortby"])) $oPagerLink->setCustom("sortby", $_REQUEST["sortby"]);
if(isset($_REQUEST["sortorder"])) $oPagerLink->setCustom("sortorder", $_REQUEST["sortorder"]);
