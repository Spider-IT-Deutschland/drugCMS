 ...
 *   modified 2015-12-04, René Mansveld, Plugins are no longer offered during setup
 *
 *   $Id$:
 * }}
 * 
...
class cSetupAdditionalPlugins extends cSetupMask {
	function __construct($step, $previous, $next) {
		...
		$this->_oStepTemplate->set("s", "DESCRIPTION", i18n_setup("Plugins can be installed after installation under <i>Extras - Plugin Manager</i>"));
